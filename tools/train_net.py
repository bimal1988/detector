...
from lib.utils.env import setup_environment  # noqa F401 isort:skip
...
from lib.solver import make_lr_scheduler
from lib.solver import make_optimizer
...
from lib.utils.miscellaneous import mkdir
...
def main():
    ...
    logger = setup_logger("detector", output_dir, get_rank())
